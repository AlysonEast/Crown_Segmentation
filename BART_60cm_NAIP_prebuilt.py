...
raster_path = f"/fs/ess/PUOM0017/ForestScaling/DeepForest/Imagery/{PRODUCT}/{SITE}/match_NEON/{PRODUCT}_2022_{SITE}_6_{PANNEL}.tif" #Update to 60cm data
...
#Predict entire tile
###################################################Patch size = 400 px, 0.6m res, 240m focal####################################
PATCH = 400
OVERLAP = 0.05
...
###################################################Patch size = 200 px, 0.6m res, 120m focal####################################
PATCH = 200
OVERLAP = 0.05
...
###################################################Patch size = 100 px, 0.6m res, 60m focal####################################
PATCH = 100
OVERLAP = 0.05
...
###################################################Patch size = 67 px, 0.6m res, 40m focal####################################
PATCH = 67
OVERLAP = 0.05
